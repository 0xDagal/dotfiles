...
run_once({ "picom --experimental-backend", "nm-applet"}) -- comma-separated entries
...
local editor_cmd = terminal_run .. editor
local browser      = "brave"
...
globalkeys = gears.table.join(
  ...
  {description = "spotify shell", group = "audio"}),
  ...
  {description = "spotify next", group = "audio"}),
  ...
  {description="launch brave browser", group="internet"}),
  awful.key({modkey,"Shift"}, "r", function () awful.spawn("rofi -theme Pop-Dark -show run -run-shell-command") end,
  ...
  -- Prompt
  awful.key({ modkey },            "r",     function () awful.spawn("rofi -show run -modi run -theme dmenu") end,
